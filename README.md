...
Мод вносит зависимость в сейв-файл и если при наличии данного мода создан сейв, то есть вероятность, что загрузить его без данного мода уже не получится или игра начнёт вести себя непредсказуемо.
